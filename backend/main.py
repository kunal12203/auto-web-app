...
from high_quality_generator import generate_high_quality_react_project
...
def enhance_react_project_with_claude(files: Dict[str, str], prompt: str) -> Dict[str, str]:
    """Generate React components - HIGH QUALITY MODE (LLM-powered for best results)"""

    logger.info("📦 Generating React components with HIGH-QUALITY mode...")

    # Use new high-quality generator that prioritizes quality over token savings
    return generate_high_quality_react_project(files, prompt)
